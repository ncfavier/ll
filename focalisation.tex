...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item If $A = X^\perp$, we have $\{X\} \subseteq \{X^\perp\}^\perp$, therefore
        $\sem{X^\perp} = \{X\}^\biperp \subseteq \{X^\perp\}^\triperp = \{X^\perp\}^\perp$.
        ...
        By the induction hypothesis, $\sem{B} \subseteq \Foc(B)^\biperp$, hence $\Foc(B)^\perp \subseteq \sem{B}^\perp$
        and $(\sem{B}^\perp \cap I)^\perp \subseteq (\Foc(B)^\perp \cap I)^\perp$.
