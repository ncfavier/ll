...
%This property is made explicit in the \emph{hypersequentialised} sequent calculus proposed by Girard~\cite{meaning},
%which considers \emph{synthetic} connectives of the same polarities.
